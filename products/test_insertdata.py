...
for data_dict in products_to_insert:
    ...
    p = Products(
        ...
        product_image_nutrition_smali=data_dict["product_image_nutrition_small"],
...
print("Les", len(products_to_insert), "produits sont, à present, sauvegardées dans la base de données!")